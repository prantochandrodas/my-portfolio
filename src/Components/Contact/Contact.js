...
const Contact = () => {
    ...
    return (
        ...
        <section class="">
            <div data-aos="zoom-in" data-aos-duration="1000" class="w-[90%] px-6 py-12 mx-auto lg:my-10">
                ...
                <div class="lg:flex lg:items-center lg:-mx-6">
                    ...
                    <div class="mt-8 lg:w-1/2 lg:mx-6">
                        <div
                            class="w-full px-8 py-10 mx-auto overflow-hidden border border-1 rounded-lg shadow-2xl dark:bg-gray-900 lg:max-w-xl shadow-gray-300/50 dark:shadow-black/50">
