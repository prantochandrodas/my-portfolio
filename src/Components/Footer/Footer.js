        ...
        <div>
            <footer className="footer p-10 bg-neutral text-neutral-content">
                <div>
                    ...
                    <p>Pranto Das<br /><FontAwesomeIcon icon={faEnvelope}></FontAwesomeIcon> prantochandrodas@gmail.com <br /> <FontAwesomeIcon icon={faLocationDot}></FontAwesomeIcon> Bangladesh, Dhaka </p>
                </div>
                <div>
